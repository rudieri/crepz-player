...
//        jScrollPane1.scrollRectToVisible(visibleRect);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JListaInteligenteEditor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JListaInteligenteEditor dialog = new JListaInteligenteEditor(new javax.swing.JFrame(), true);
